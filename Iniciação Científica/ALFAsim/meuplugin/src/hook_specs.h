...
#ifndef ALFASIM_HOOK_SPECS_HEADER_FILE
#define ALFASIM_HOOK_SPECS_HEADER_FILE
#ifdef __cplusplus
...
HOOKMAN_API_EXP const char* HOOKMAN_FUNC_EXP alfasim_version_api() {
    return "v1";
}
...
*/
#define HOOK_INITIALIZE(ctx) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_initialize(void* ctx)
...
*/
#define HOOK_FINALIZE(ctx) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_finalize(void* ctx)
...
*/
#define HOOK_UPDATE_PLUGINS_SECONDARY_VARIABLES_ON_FIRST_TIMESTEP(ctx) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_update_plugins_secondary_variables_on_first_timestep(void* ctx)
...
*/
#define HOOK_UPDATE_PLUGINS_SECONDARY_VARIABLES_TIME_EXPLICIT(ctx) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_update_plugins_secondary_variables_time_explicit(void* ctx)
...
*/
#define HOOK_UPDATE_PLUGINS_SECONDARY_VARIABLES(ctx) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_update_plugins_secondary_variables(void* ctx)
...
*/
#define HOOK_UPDATE_PLUGINS_SECONDARY_VARIABLES_ON_TRACER_SOLVER(ctx) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_update_plugins_secondary_variables_on_tracer_solver(void* ctx)
...
*/
#define HOOK_CALCULATE_MASS_SOURCE_TERM(ctx, mass_source, n_fields, n_control_volumes) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_mass_source_term(void* ctx, void* mass_source, int n_fields, int n_control_volumes)
...
``n_faces``.
*/
#define HOOK_CALCULATE_MOMENTUM_SOURCE_TERM(ctx, momentum_source, n_layers, n_faces) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_momentum_source_term(void* ctx, void* momentum_source, int n_layers, int n_faces)
...
``n_control_volumes``.
*/
#define HOOK_CALCULATE_ENERGY_SOURCE_TERM(ctx, energy_source, n_energy_equation, n_control_volumes) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_energy_source_term(void* ctx, void* energy_source, int n_energy_equation, int n_control_volumes)
...
``n_control_volumes``.
*/
#define HOOK_CALCULATE_TRACER_SOURCE_TERM(ctx, phi_source, n_tracers, n_control_volumes) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_tracer_source_term(void* ctx, void* phi_source, int n_tracers, int n_control_volumes)
...
just return ``OK``.
*/
#define HOOK_INITIALIZE_STATE_VARIABLES_CALCULATOR(ctx, P, T, T_mix, phi, n_control_volumes, n_layers, n_tracers) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_initialize_state_variables_calculator(void* ctx, void* P, void* T, void* T_mix, void* phi, int n_control_volumes, int n_layers, int n_tracers)
...
*/
#define HOOK_FINALIZE_STATE_VARIABLES_CALCULATOR(ctx) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_finalize_state_variables_calculator(void* ctx)
...
.. warning::
    ...
    ``n_control_volumes`` .
*/
#define HOOK_CALCULATE_STATE_VARIABLE(ctx, P, T, n_control_volumes, phase_id, field_id, property_id, output) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_state_variable(void* ctx, void* P, void* T, int n_control_volumes, int phase_id, int field_id, int property_id, void* output)
...
.. warning::
    ...
    ``n_control_volumes``.
*/
#define HOOK_CALCULATE_PHASE_PAIR_STATE_VARIABLE(ctx, P, T_mix, n_control_volumes, phase1_id, phase2_id, phase_pair_id, property_id, output) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_phase_pair_state_variable(void* ctx, void* P, void* T_mix, int n_control_volumes, int phase1_id, int phase2_id, int phase_pair_id, int property_id, void* output)
...
*/
#define HOOK_INITIALIZE_PARTICLE_DIAMETER_OF_SOLIDS_FIELDS(ctx, particle_diameter, n_control_volumes, solid_field_id) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_initialize_particle_diameter_of_solids_fields(void* ctx, void* particle_diameter, int n_control_volumes, int solid_field_id)
...
*/
#define HOOK_UPDATE_PARTICLE_DIAMETER_OF_SOLIDS_FIELDS(ctx, particle_diameter, n_control_volumes, solid_field_id) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_update_particle_diameter_of_solids_fields(void* ctx, void* particle_diameter, int n_control_volumes, int solid_field_id)
...
*/
#define HOOK_CALCULATE_SLIP_VELOCITY(ctx, U_slip, solid_field_index, layer_index, n_faces) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_slip_velocity(void* ctx, double* U_slip, int solid_field_index, int layer_index, int n_faces)
...
*/
#define HOOK_CALCULATE_RELATIVE_SLURRY_VISCOSITY(ctx, mu_r, solid_field_index, layer_index, n_faces) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_relative_slurry_viscosity(void* ctx, double* mu_r, int solid_field_index, int layer_index, int n_faces)
...
*/
#define HOOK_INITIALIZE_MASS_FRACTION_OF_TRACER(ctx, phi_initial, tracer_index) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_initialize_mass_fraction_of_tracer(void* ctx, void* phi_initial, int tracer_index)
...
*/
#define HOOK_CALCULATE_MASS_FRACTION_OF_TRACER_IN_PHASE(ctx, phi, phi_phase, tracer_index, phase_index, n_control_volumes) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_mass_fraction_of_tracer_in_phase(void* ctx, void* phi, void* phi_phase, int tracer_index, int phase_index, int n_control_volumes)
...
*/
#define HOOK_CALCULATE_MASS_FRACTION_OF_TRACER_IN_FIELD(ctx, phi_phase, phi_field, tracer_index, field_index, phase_index_of_field, n_control_volumes) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_mass_fraction_of_tracer_in_field(void* ctx, void* phi_phase, void* phi_field, int tracer_index, int field_index, int phase_index_of_field, int n_control_volumes)
...
*/
#define HOOK_SET_PRESCRIBED_BOUNDARY_CONDITION_OF_MASS_FRACTION_OF_TRACER(ctx, phi_presc, tracer_index) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_set_prescribed_boundary_condition_of_mass_fraction_of_tracer(void* ctx, void* phi_presc, int tracer_index)
...
*/
#define HOOK_UPDATE_BOUNDARY_CONDITION_OF_MASS_FRACTION_OF_TRACER(ctx, phi_presc, tracer_index, vol_frac_bound, n_fields) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_update_boundary_condition_of_mass_fraction_of_tracer(void* ctx, void* phi_presc, int tracer_index, void* vol_frac_bound, int n_fields)
...
*/
#define HOOK_CALCULATE_UCM_FRICTION_FACTOR_STRATIFIED(ctx, ff_wG, ff_wL, ff_i) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_ucm_friction_factor_stratified(void* ctx, double* ff_wG, double* ff_wL, double* ff_i)
...
*/
#define HOOK_CALCULATE_UCM_FRICTION_FACTOR_ANNULAR(ctx, ff_wG, ff_wL, ff_i) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_ucm_friction_factor_annular(void* ctx, double* ff_wG, double* ff_wL, double* ff_i)
...
*/
#define HOOK_CALCULATE_LIQ_LIQ_FLOW_PATTERN(ctx, ll_fp, water_vol_frac) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_liq_liq_flow_pattern(void* ctx, int* ll_fp, double* water_vol_frac)
...
*/
#define HOOK_CALCULATE_LIQUID_EFFECTIVE_VISCOSITY(ctx, mu_l_eff, ll_fp) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_liquid_effective_viscosity(void* ctx, double* mu_l_eff, int ll_fp)
...
*/
#define HOOK_CALCULATE_GAS_LIQ_SURFACE_TENSION(ctx, sigma_gl, ll_fp) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_gas_liq_surface_tension(void* ctx, double* sigma_gl, int ll_fp)
...
*/
#define HOOK_CALCULATE_LIQ_LIQ_SHEAR_FORCE_PER_VOLUME(ctx, shear_w, shear_i, u_fields, vol_frac_fields, ll_fp) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_liq_liq_shear_force_per_volume(void* ctx, double* shear_w, double* shear_i, double* u_fields, double* vol_frac_fields, int ll_fp)
...
*/
#define HOOK_CALCULATE_RELATIVE_EMULSION_VISCOSITY(ctx, mu_r, mu_disp, mu_cont, alpha_disp_in_layer, T, water_in_oil) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_calculate_relative_emulsion_viscosity(void* ctx, double* mu_r, double mu_disp, double mu_cont, double alpha_disp_in_layer, double T, bool water_in_oil)

/*!
Docs for Friction Factor
*/
#define HOOK_FRICTION_FACTOR(v1, v2) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_friction_factor(int v1, int v2)

/*!
Docs for Environment Temperature
*/
#define HOOK_ENV_TEMPERATURE(v3, v4) HOOKMAN_API_EXP float HOOKMAN_FUNC_EXP alfasim_v1_env_temperature(float v3, float v4)
...
*/
#define HOOK_CALCULATE_ENTRAINED_LIQUID_FRACTION(U_S, rho, mu, sigma, D, theta) HOOKMAN_API_EXP double HOOKMAN_FUNC_EXP alfasim_v1_calculate_entrained_liquid_fraction(const double U_S[2], const double rho[2], const double mu[2], double sigma, double D, double theta)
...
*/
#define HOOK_UPDATE_INTERNAL_DEPOSITION_LAYER(ctx, phase_id, thickness_variation_rate, density, heat_capacity, thermal_conductivity, n_control_volumes) HOOKMAN_API_EXP int HOOKMAN_FUNC_EXP alfasim_v1_update_internal_deposition_layer(void* ctx, int* phase_id, void* thickness_variation_rate, void* density, void* heat_capacity, void* thermal_conductivity, int n_control_volumes)


#endif // ALFASIM_HOOK_SPECS_HEADER_FILE
